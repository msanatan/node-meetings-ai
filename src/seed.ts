...
import { Meeting, IMeeting } from "./services/meetings/meeting.model.js";
import { Task, ITask } from "./services/tasks/task.model.js";

dotenv.config();

const MONGODB_URI =
  process.env.MONGO_URI || "mongodb://localhost:27017/meetingbot";
